...
def run_long_video_integration():
    ...
    print("\n" + "=" * 80)
    print("🔥 Hetero-KV × Qwen2-VL: 极简环境夹缝生存压测")
    print("=" * 80)
    ...
    print("\n[Step 2] 解析长视频 (开启极速降维压缩)...")
    # 🔥 核心修改：大幅降低视频解析的内存负担，确保安全度过 ViT 阶段
    messages = [
        {
            "role": "user",
            "content": [
                {
                    ...
                    "fps": 0.5,  # 降低到 0.5 fps (每2秒抽1帧)，将帧数砍半
                    "max_pixels": 31360  # 大幅降低单帧分辨率限制 (约 176x176)，极度压缩 ViT 开销
                },
