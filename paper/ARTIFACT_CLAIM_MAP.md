...
| WikiText-2 PPL degradation is controlled on tested SourceCopy-disabled suffix setups | Supported | 14K PPL JSON, 16K PPL JSON, and 16K offset32768 PPL JSON | `paper/figures/ppl_relative_delta_by_context.svg` | This is not a 128K PPL claim |
...
| 128K WikiText-2 PPL is validated | Current PPL evidence is 14K and 16K suffix evaluation |
