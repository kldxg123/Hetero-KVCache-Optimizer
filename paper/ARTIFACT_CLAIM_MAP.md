...
| WikiText-2 PPL degradation is controlled on tested SourceCopy-disabled suffix setups | Supported | 14K PPL JSON and 16K PPL JSON | `paper/figures/ppl_relative_delta_by_context.svg` | This is not a 128K PPL claim |
