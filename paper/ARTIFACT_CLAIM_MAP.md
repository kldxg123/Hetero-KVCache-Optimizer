...
| WikiText-2 PPL degradation is controlled on tested SourceCopy-disabled suffix setups | Supported | 14K, 16K, 16K offset32768, and 32K PPL JSON artifacts | `paper/figures/ppl_relative_delta_by_context.svg` | This is not a 128K PPL claim |
