...
\begin{itemize}
    ...
    \item \textbf{Hetero-KV}: Uses 4-bit quantization ($\sim$2$\times$ storage compression, 48\% volume reduction via uint8 storage) and the Transient Cache Interception to overlap prefetch with compute.
\end{itemize}
